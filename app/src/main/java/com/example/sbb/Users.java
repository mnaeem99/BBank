...
/*
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<UsersModal> options =
                new FirebaseRecyclerOptions.Builder<UsersModal>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Users"), UsersModal.class)
                        .build();
        myAdapter = new UsersAdapter(options,this.getContext());
